...
{% swagger method="post" path="/sapi/v1/margin/order" baseUrl="https://openapi.xxx.xx" summary=" New Order" %}
{% swagger-description %}
...
{% swagger method="get" path="/sapi/v1/margin/order" baseUrl="https://openapi.xxx.xx" summary=" Query Order" %}
{% swagger-description %}
...
Symbol Name.E.g. `BTCUSDT`Header
{% endswagger-parameter %}
...
{% swagger method="post" path="/sapi/v1/margin/cancel" baseUrl="https://openapi.xxx.xx" summary=" Cancel Order" %}
{% swagger-description %}
**Rate Limit: 100times/2s**
{% endswagger-description %}
...
{% swagger-parameter in="body" name="newClientOrderId" %}
Symbol Name. E.g. `BTCUSDT`Responses200GET
{% endswagger-parameter %}
...
{% swagger method="get" path="/sapi/v1/margin/openOrders" baseUrl="https://openapi.xxx.xx" summary=" Current Open Orders" %}
{% swagger-description %}
**Rate Limit: 20times/2s**
{% endswagger-description %}
...
{% swagger method="get" path="/sapi/v1/margin/myTrades" baseUrl="https://openapi.xxx.xx" summary="Trades" %}
{% swagger-description %}
